...
$(function () {
	...
	$("#iiecsrc_el--overlayer").delay(700).fadeOut("slow");
	...
	var siteMenuClone = function () {
		...
		setTimeout(function () {
			var counter = 0;
			$('.iiecsrc_el--site-mobile-menu .has-children').each(function () {
				var $this = $(this);
		...
		//var container = $(".iiecsrc_el--site-mobile-menu");
	...
	var heroInnerPage = function () {
		...
		setTimeout(function () {
			tl
				.set('.inner-page .hero-heading > span > span > span > span', {
					y: "100%",
				...
				.staggerFromTo('.inner-page .hero-heading > span > span > span > span', 2, {
					opacity: 1,
					rotation: "20%",
					y: "100%"
				}, {
		...
		owlHeroSlider.owlCarousel({
			...
			onInitialize: function () {
				setTimeout(function () {
					...
					tl
						.set('.owl-item.active .hero-heading > span > span > span > span', {
							y: "100%",
							transformStyle: "preserve-3d"
						})
						...
						.staggerFromTo('.owl-item.active .hero-heading > span > span > span > span', 2, {
							opacity: 1,
							rotation: "20%",
							y: "100%"
						}, {
						...
						.fromTo('.owl-item.active .sub-text', 1, {
							autoAlpha: 0,
							y: 20
						}, {
							autoAlpha: 1,
